...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${apiConfig.apiHost}/register`, formDataToSend, {
        headers: {
    ...
    <div className="register">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input type="number" name="alter_phone" value={formData.alter_phone} onChange={handleChange} />
        </div>
